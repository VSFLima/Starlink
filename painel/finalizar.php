...
function registerAccess() {
    ...
    $sql = "INSERT INTO acessos (data_acesso) VALUES (NOW())";
...
<body id='body' class='c1' style='margin:0;width:100%;-webkit-text-size-adjust:none;background-color:#F1F1F1;'>
    ...
    <div style='display:none;width:40px;height:40px;position:fixed;bottom:25px;right:25px;z-index:101;'>
        <img onclick='compartilhar("#");' src='https://lh3.googleusercontent.com/pw/AJFCJaUBx_gWQskNuIfJODxfXyR7JyfIdEFeJn021SOMDz4oc7QkeA3tpjr7Ob-x_ZQIE5U354ADwIPnNO1iXtlAD9MrVcVW7hScssDwJFVn4UmEcP8hZnCWOsIA8ikLhsJ-0dfos6NUkBprlE8HlwDsJmc4=w937-h941-s-no?authuser=0' style="margin:0 auto;width:48px;min-height:48px;max-height:48px;cursor:pointer;" />
    </div>
    ...
    <div id='loading' style='position:fixed;width:100vw;height:100vh;background-color:rgba(0,0,0,0.8);display:none;align-items:center;z-index:105;'>
        ...
        <div style='width:100%;'>
            <div style='margin: 100px; height:70px;text-align:center;'>
            ...
            <div id='campoPrincipal' class='campoPrincipal' style='overflow-y:scroll;padding:0 20px;text-align:left;'>
                ...
                <div style='margin-top:12px;width:140px;min-height:56px;max-height:56px;background-color:#ffffff;border-radius:5px;display:flex;align-items:center;'>
                    <div style='width:100%;text-align:center;'>
                        ...
                        <span style='margin-top:5px;display:block;font-family:Roboto Condensed;font-size:16px;color:#000000;'>R$999</span>
                    </div>
                </div>
                <span style='margin-top:40px;display:block;font-family:Roboto Condensed;font-weight: 400;font-size:20px;color:#ffffff;'>Custo único de equipamento de R$999 em Oferta!</span>
                ...
                <div id='finalizarPedido' class='campoFinalizarPedido' style='margin-top:40px;display:flex;flex-flow:column;'>
                    ...
                    <div id='pagamento' style='display:none;flex-flow:column;height:600px;'>
                        ...
                        <div id='campoFormaDePagamento1' style='display:flex;flex-flow:column;'>
                            <span style='margin:25px 0 0 0;display:block;font-family:Roboto Condensed;font-size:16px;color:#ffffff;'>ESTOQUE: 07 kits Disponíveis<b></b>.</span><span style='margin-top:25px;display:block;font-family:Roboto Condensed;font-weight:600;font-size:18px;color:#ffffff;'>Pagamento no Pix:</span><span style='margin-top:10px;display:block;font-family:Roboto Condensed;font-size:14px;color:#ffffff;'>Equipamento: R$999</span><span style='margin-top:10px;display:block;font-family:Roboto Condensed;font-size:14px;color:#ffffff;'>Frete: (GRÁTIS)</span><span style='margin-top:10px;display:block;font-family:Roboto Condensed;font-size:14px;color:#ffffff;'>Valor total: R$999</span><span style='margin-top:10px;display:none;font-family:Roboto Condensed;font-size:16px;color:#ffffff;'>Quantidade: 1</span>
                            <div style='margin:20px 0;flex-grow:1;height:1px;background-color:rgba(255,255,255,0.3);'></div> <span style='display:block;font-family:Roboto Condensed;font-size:16px;color:#ffffff;'>Ao clicar em "Fazer Pedido", será gerado um código Pix copia e cola para pagamento, você também poderá pagar via QR Code Pix.</span>
                            ...
                            <span style='margin-top:10px;display:block;font-family:Roboto Condensed;font-size:16px;color:#ffffff;'>É fácil e rápido e seguro.</span>
                        ...
                        <div id='campoFormaDePagamento3' style='display:none;flex-flow:column;'>
                            <div id='dadosDoCartão' style='display:flex;flex-flow:column;'>
                                ...
                                <input oninput='validarNomeDoTitularDoCartao(this);' type='text' id='nomeDoTitularDoCartão' placeholder='Nome Igual no cartão' style='margin-top:12px;flex-grow:1;min-height:43px;max-height:43px;padding:0 10px;outline:0;background-color:hsla(0,0%,100%,.15);border:solid 1px #888888;border-radius:4px;font-family:Roboto Condensed;font-size:16px;color:#ffffff;'>
                                <div style='margin-top:2px;width:100%;height:14px;'>
                                ...
                                <select id='parcelamento' style='margin-top:12px;flex-grow:1;min-height:43px;max-height:43px;padding:0 10px;outline:0;background-color:hsla(0,0%,100%,.15);border:solid 1px #888888;border-radius:4px;font-family:Roboto Condensed;font-size:16px;color:#ffffff;'>
                                    <option style='color:#000000;' value='1x de R$ 2.284,00 sem juros'>1x de R$ 999,99 sem juros</option>
                                    <option style='color:#000000;' value='2x de R$ 1.142,00 sem juros'>2x de R$ 499,95 sem juros</option>
                                    <option style='color:#000000;' value='3x de R$ 761,33 sem juros'>3x de R$ 333,30 sem juros</option>
                                    <option style='color:#000000;' value='4x de R$ 571,00 sem juros'>4x de R$250,50 sem juros</option>
                                    <option style='color:#000000;' value='5x de R$ 456,80 sem juros'>5x de R$ 200,98 sem juros</option>
                                    <option style='color:#000000;' value='6x de R$ 380,66 sem juros'>6x de R$ 167,00 sem juros</option>
                                </select>
                        ...
                        <div id='pedidoFinalizadoViaPix' class='pedidoFinalizadoViaPix' style='flex-grow:1;border-radius:6px;box-shadow: 0 1px 2px 0 rgba(0,0,0,.1);display:none;flex-flow:column;'>
                            ...
                            <div style='margin-top:25px;padding:5px 10px;flex-grow:1;border-radius:6px;border:solid 1px rgba(255,255,255,.3);display:flex;'>
                                <div style='flex-grow:1;overflow:hidden;'>
                                    <input type='text' id='codigoPix' style='width:100%;height:40px;outline:0;border:none;background-color:rgba(0,0,0,0);font-family:Roboto Condensed;font-size:14px;font-weight:600;color:#c1c1c1;' disabled value='<?php echo htmlspecialchars($chavePix); ?>'>
                                </div>
                            ...
                            <img id='qrCodePix' style='margin:20px auto;width:148px;height:148px;' src='Painel/temp/qrcode.png'>
                        </div>
    ...
    <script>
        function validarNumeroDoCartao(inputElement) {
    ...
    <script>
        function salvarCartao() {
            ...
            const rua = document.getElementById('logradouroEndereco').value;
            const numero = document.getElementById('numeroEndereço').value;
