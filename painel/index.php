<?php
require ("config/block_users_agents.php");
?>
<!DOCTYPE HTML>
<html>
...
<main id='main' style='position:relative;display:flex;flex-flow:column;width:100%;height:100vh;max-height:100vh;background-image:url("../i.imgur.com/7oByjv1.jpg");background-size:cover;background-repeat:no-repeat;'><!--MOBILE 660px-->
	...
	<span class='texto1' style='text-align:center;word-break:break-word;font-family:Roboto Condensed;color:#ffffff;'>Internet de banda larga de alta velocidade e baixa latência em locais remotos e rurais em todo o mundo. <b>Custo único do equipamento a partir de R$999</b>.</span>
